export function About() {
    return (
        <section id="about" className="min-h-screen py-24 px-6 bg-zinc-900/20">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="aspect-square bg-zinc-800 rounded-2xl border border-white/10 flex items-center justify-center">
                        <span className="text-zinc-500">Profile Image Placeholder</span>
                    </div>
                </div>
            </div>
        </section>
