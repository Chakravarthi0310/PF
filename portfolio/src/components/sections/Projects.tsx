            ...
            <div className="max-w-6xl mx-auto px-6">
                ...
                <div className="space-y-8">
                    {projects.map((project) => (
                        <div
                            key={project.title}
                            className="group relative p-8 rounded-2xl border border-zinc-800 bg-zinc-900/30 hover:bg-zinc-900/50 hover:border-zinc-700 transition-all duration-300 hover:shadow-xl hover:shadow-zinc-900/50"
                        >
                            {/* Subtle gradient overlay on hover */}
                            <div className="absolute inset-0 bg-gradient-to-br from-blue-950/0 to-purple-950/0 group-hover:from-blue-950/10 group-hover:to-purple-950/10 rounded-2xl transition-all duration-300 pointer-events-none" />
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {project.tech.map((tech) => (
                                        <span
                                            key={tech}
                                            className="px-3 py-1.5 text-sm border border-zinc-700 rounded-lg bg-zinc-900/50 text-zinc-300 hover:border-zinc-600 hover:bg-zinc-800/50 transition-colors"
                                        >
                                            {tech}
                                        </span>
                                    ))}
